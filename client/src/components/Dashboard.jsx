...
const Dashboard = () => {
    ...
    const getAllShayari = async () => {
        ...
        try {
            ...
            console.log("Error in getAllShayari", error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const deleteShayari = async (id) => {
        ...
        try {
            ...
            if (error) throw error;
            setShayariData((prev) => prev.filter((item) => item.id !== id));
        } catch (error) {
            console.error(error);
        } finally {
            setLoading(false);
            ...
            <div className="max-w-5xl mx-auto mb-8">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        className="bg-white/10 backdrop-blur-md border border-purple-400/20 text-white px-4 py-2 rounded-md hover:bg-white/20 transition flex items-center gap-2"
                    >
                            ...
                            >
                                <div>
                                    ...
                                    <div className="flex justify-between ">
                                        ...
                                        <button
                                            onClick={() =>
                                                deleteShayari(item.id)
                                            }
                                            className="text-xs text-yellow-400 mt-2 italic hover:text-red-600 cursor-pointer"
                                        >
                                            <Trash2 />
                                        </button>
                                    </div>
